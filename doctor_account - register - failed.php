...
<div class="container-fluid padding">
    ...
    <div class="row register-form">
      <div class="col-lg-6 col-12 mx-auto">
        <div class="card form-block mx-auto">
          <div class="card-title text-center pt-3">
            <h5 class="display-4">Doctor Register</h5>
          </div>
          <div class="card-body">
            <form action="doctor_register.php" method="post" autocomplete="off">
              ...
              <button type="submit" class="btn btn-primary">Submit</button>
							<p class="text-warning" style="font-size: 60%">Username already exists, please choose another.</p>
            </form>
          </div>
        </div>
      </div>
	...
	<div class="row text-center">
		<div class="col-12">
			<a href="doctor_patient_table.php"><button type="link" class="btn btn-primary">View Patient Table</button></a>
		</div>
	</div>
