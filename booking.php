...
<div class="container-fluid padding">
    ...
    <div class="col-12 justify-content-center">
			<form class="form" method="POST" action="book.php">
				<div class="row">
					<div class="col">
						<div class="row">
							<div class="col">
								<div class="form-group">
									...
									<p name="username" id="username"><?=$_SESSION['name']?></p>
								</div>
							</div>
						</div>
						<div class="row">
						...
						<div class="row">
							<div class="col">
								<div class="form-group">
									...
									<input class="form-control" type="date" name="Appointment Date" id="adate" placeholder="Appointment Date"/>
								</div>
							</div>
							<div class="col">
								<div class="form-group">
									<label>Appointment Time</label>
									<input class="form-control" type="time" name="slot" id="atime" placeholder="Appointment Time">
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col mb-3">
								<div class="form-group">
									...
									<textarea class="form-control" rows="5" placeholder="Description your symptoms" id="symptoms"></textarea>
								</div>
							</div>
						</div>
